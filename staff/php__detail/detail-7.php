        ...
        <div id="detail-page" class="container detail-page">
            ...
            <aside class="interview visible-pc">
                ...
                <div class="interview__list">
                    ...
                    <a class="interview__item" href="detail-4.php">
                    ...
                    <a class="interview__item" href="detail-5.php">
                    ...
                    <a class="interview__item" href="detail-6.php">
                    ...
                    <a class="interview__item" href="detail-9.php">
                    ...
                    <a class="interview__item" href="detail-10.php">
                    ...
                    <a class="interview__item" href="detail-11.php">
