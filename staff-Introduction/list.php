        ...
        <header class="header">
            <div class="header__inner">
                <div class="header__item">
                    ...
                    <div class="header__link visible-pc"><a href=".html">スタッフ紹介</a></div>
                </div>
            ...
            <div class="container">
                ...
                <ul class="staff__list">
                    <li class="staff__item">
                        ...
                        <h3 class="staff__name staff__name__1">名前が入ります（職種が入ります）</h3>
                    ...
                    <li class="staff__item">
                        ...
                        <h3 class="staff__name staff__name__2">名前が入ります（職種が入ります）</h3>
                        <time class="staff__date">2022年3月1日（火）</time>
                        <p class="staff__detail">インタビューテキストインタビューテキストインタビューテキスト
                            インタビューテキストインタビューテキストインタビューテキストインタビューテキスト</p>
                ...
                <ul class="pagination">
                    ...
                    <li class="pagination__item">
                        <a class="pagination__link" tab="-1">1 / 1</a>
                    </li>
                    <li class="pagination__item">
